---
title: "The Factory Next Door"
description: "How $840 billion in annual trade, the most prescriptive rules of origin ever written, and a 28-point tariff gap are quietly binding Mexico into America's industrial architecture."
date: 2026-02-26T08:30:00-05:00
draft: false
math: false
tags: ["geopolitics", "trade", "mexico", "usmca", "manufacturing", "nearshoring", "tariffs", "china", "fortress-hemisphere"]
categories: ["Analysis", "Geopolitics"]
image: "/img/fortress-hemisphere/the-factory-next-door.png"
---
...
- [Part 1: Follow the Pipes](/analysis/follow-the-pipes/) -- The Guyana oil boom and hemispheric energy strategy
- [Part 2: The Squeeze](/analysis/the-squeeze/) -- How Chinese capital is being removed from every chokepoint
...
- [Part 4: The Trillion-Dollar Tell](/analysis/the-trillion-dollar-tell/) -- The automation bet, the labor gap, and a $650 billion wager on what comes next
- [Part 5: The Roof](/analysis/the-roof/) -- Icebreakers, Arctic trade routes, and the top of the architecture
...
The higher rates they were avoiding were the ones hitting everyone else. By December 2025, the US effective tariff rate on Chinese goods was 33.4%. The overall average had climbed to levels not seen since the 1930s. Mexico's effective rate? Below 5%. (For a detailed breakdown of how the tariff regime actually works at the country level -- headline rates vs. effective rates, exemption structures, and the strategic hierarchy -- see [The Firewall with Ports](/deep-dives/the-firewall-with-ports/).)
...
Step back, the way I did with Guyana in the [first post](/analysis/follow-the-pipes/), and look at what's actually in front of you.
...
In the [first post](/analysis/follow-the-pipes/), I followed the energy supply chain and found the early stages of hemispheric consolidation. In the [second](/analysis/the-squeeze/), I followed the infrastructure squeeze and found a systematic effort to remove Chinese presence from the hemisphere's chokepoints. Here, in the trade data, the same pattern -- different actors, different mechanisms, same structural outcome.
...
*This is Part 3 of the Fortress Hemisphere series. [Part 1: Follow the Pipes](/analysis/follow-the-pipes/) covers the Guyana energy story. [Part 2: The Squeeze](/analysis/the-squeeze/) covers the systematic removal of Chinese infrastructure from the hemisphere.*

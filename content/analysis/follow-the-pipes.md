---
title: "Follow the Pipes"
description: "How a country most Americans can't find on a map became the center of US energy strategy, and what the Guyana oil boom reveals about where American power is actually headed."
date: 2026-02-26T08:00:00-05:00
draft: false
math: false
tags: ["geopolitics", "energy", "oil", "guyana", "exxonmobil", "venezuela", "china", "cnooc", "fortress-hemisphere"]
categories: ["Analysis", "Geopolitics"]
image: "/img/fortress-hemisphere/follow-the-pipes.png"
---
...
Guyana is the clearest example -- but it's not the only one. In the [next post](/analysis/the-squeeze/), I'll follow this same approach into the systematic removal of Chinese capital from the hemisphere's chokepoints -- and what a port seizure in Panama, a trade clause in USMCA, and a 5G ban in Costa Rica all have in common.
...
*This is Part 1 of the Fortress Hemisphere series. [Part 2: The Squeeze](/analysis/the-squeeze/) covers the systematic removal of Chinese infrastructure from the hemisphere. [Part 3: The Factory Next Door](/analysis/the-factory-next-door/) examines how $840B in annual trade is binding Mexico into America's industrial architecture. [Part 4: The Trillion-Dollar Tell](/analysis/the-trillion-dollar-tell/) covers the automation bet and the labor gap. [Part 5: The Roof](/analysis/the-roof/) covers the Arctic, icebreakers, and the top of the architecture.*

---
title: "The Squeeze"
description: "How Chinese capital is being systematically removed from every chokepoint in the Western Hemisphere — through contracts, court rulings, trade clauses, and tariff schedules."
date: 2026-02-26T08:15:00-05:00
draft: false
tags: ["geopolitics", "china", "trade", "panama", "canada", "mexico", "costa-rica", "usmca", "infrastructure", "fortress-hemisphere"]
categories: ["Analysis", "Geopolitics"]
image: "/img/fortress-hemisphere/the-squeeze.png"
---
...
- [Part 3: The Factory Next Door](/analysis/the-factory-next-door/) — How $840 billion in annual trade is binding Mexico into America's industrial architecture
...
In the [first post in this series](/analysis/follow-the-pipes/), I laid out how the United States has quietly built an energy architecture in Guyana — the fastest-growing oil basin on earth, operated by ExxonMobil, secured by the US Navy, pumping 900,000 barrels a day and heading toward 1.7 million by 2030.
...
In the [first post](/analysis/follow-the-pipes/), I showed that 66% of Guyana's crude exports went to Europe in 2024. The US doesn't need to hoard the barrels. It controls the architecture that produces them, and it directs them to allies.

But that architecture only works if you control the logistics layer. Oil that gets pumped in Guyana and shipped to Rotterdam moves through the Atlantic, past the Caribbean, through or around the Panama Canal. The shipping lanes, the port infrastructure, the chokepoints — all of that matters.
...
*All claims in this post are sourced from publicly available materials including: CNBC, Reuters, Bloomberg, CBC News, Globe and Mail, Al Jazeera, France 24, the US State Department, the Canadian Prime Minister's Office, CK Hutchison Holdings' stock exchange filings, the USMCA text (Article 32.10), USTR hearing testimony (December 2025), the Dallas Federal Reserve, the Brookings Institution, CSIS, Heritage Foundation, US Treasury International Capital data, and Statistics Canada. The Panama port seizure was reported on February 23-24, 2026, by Reuters, CNBC, Bloomberg, Al Jazeera, and France 24.*

*This is Part 2 of the Fortress Hemisphere series. [Part 1: Follow the Pipes](/analysis/follow-the-pipes/) covers the Guyana energy story. [Part 3: The Factory Next Door](/analysis/the-factory-next-door/) examines how $840B in annual trade is binding Mexico into America's industrial architecture.*
